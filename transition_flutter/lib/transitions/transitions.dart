...
class TransitionsExample {
  ...
  static pageRouteBuilder(fooTransition, screen) =>
      PageRouteBuilder(
          transitionDuration: const Duration(seconds: 5), //Duracion de la trsnsicion al mostrarse
          reverseTransitionDuration:const Duration(seconds: 2), //Duracion de la trsnsicion al desaparecer
